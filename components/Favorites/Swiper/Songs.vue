  ...
  <div class="mt-10">
    <section>
      <div class="mb-2 mt-4 flex items-center">
        ...
        <div class="ml-2 flex items-center">
          <span class="font-bold">The Woman I Love (Jason Mraz)</span>
          <a
            href="https://open.spotify.com/track/6Vn8lTVMjILXQCjZUXS8n4?si=02a66556b0e541fa"
            target="_blank"
            class="ml-2 pt-1.5"
          >
    ...
    <section>
      <div class="mb-2 mt-4 flex items-center">
        ...
        <div class="ml-2 flex items-center">
          <span class="font-bold">If You Stay (Joseph Vincent)</span>
          <a
    ...
    <section>
      <div class="mb-2 mt-4 flex items-center">
        ...
        <div class="ml-2 flex items-center">
          <span class="font-bold">Passenger Seat (Stephen Speaks)</span>
          <a
