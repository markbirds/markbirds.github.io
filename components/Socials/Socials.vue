  ...
  <section class="mw-full md:w-[80%] lg:w-[60%] mx-4 md:mx-auto md:mt-24 my-16 text-gray-600 cursor-default">
    ...
    <section class="my-2 grid md:grid-cols-3 gap-2 w-full text-center">
      <section class="bg-slate-100 rounded-lg transition hover:bg-slate-200 duration-500">
        ...
        <div class="p-4">
          <a href="https://www.instagram.com/owenfalculan/" target="_blank">
            @owenfalculan
          </a>
        </div>
      </section>
      <section class="bg-slate-100 rounded-lg transition hover:bg-slate-200 duration-500">
        ...
        <div class="p-4">
          <a href="https://www.linkedin.com/in/owen-patrick-falculan-4500b521a/" target="_blank">
      ...
      <section class="bg-slate-100 rounded-lg transition hover:bg-slate-200 duration-500">
        ...
        <div class="p-4">
          <a href="https://github.com/markbirds" target="_blank">
            markbirds
          </a>
        </div>
      </section>
